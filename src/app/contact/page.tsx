      ...
      <div className="mx-auto max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="animate-fade-in">
          ...
          <p className="mt-4 text-muted-foreground">
            Feel free to reach out via email or phone, or simply use the form on this page. I look forward to connecting with you.
          </p>
          <div className="mt-8 space-y-4">
            <div className="flex items-center gap-4">
              <Mail className="h-6 w-6 text-primary"/>
              <a href="mailto:hello@designnoir.com" className="hover:text-primary transition-colors">
                hello@designnoir.com
              </a>
            </div>
            <div className="flex items-center gap-4">
